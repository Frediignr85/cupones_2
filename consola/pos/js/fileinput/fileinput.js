...
(function ($) {
    ...
    var CAPTION_TEMPLATE = '<div class="form-control file-caption {class}">\n' +
        '   <span class="icon-folder5"></span> <span class="file-caption-name"></span>\n' +
        '</div>';
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="icon-camera5"></i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeLabel: 'Remove',
        removeIcon: '<i class="icon-circle-with-minus"></i> ',
        removeClass: 'btn btn-default',
        uploadLabel: 'Subir',
        uploadIcon: '<i class="icon-upload6"></i> ',
