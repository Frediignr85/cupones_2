<!-- Footer Start -->
<footer>
<a href="http://OpenSolutionSystems.com"> © OpenSolutions </a> <span><?php echo date("Y");?>	</span>
</footer>
<!-- Footer end -->

<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="js/jquery-2.1.1.js"></script>
<!--script src="js/jquery/jquery-3.3.1.min.map"></script>
...
<script src='js/typehead/bootstrap3-typeahead.js'></script>
