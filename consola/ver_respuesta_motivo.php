...
<div class="modal-header">
    ...
    <h4 class="modal-title text-navy">Ver Respuesta al Motivo de Rechazo</h4>
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group has-info text-center alert alert-info">
                          <label><?php echo "Respuesta."; ?></label>
                      </div>
                    </div>
                    <br>
                    <div class='col-md-12'>
