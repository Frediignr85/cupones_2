...
<div class="modal-header">
    ...
    <h4 class="modal-title text-navy">Borrar Oferta</h4>
</div>
...
function deleted()
{
    ...
    $desactivar  = _desactivar('ofertas'," WHERE id_oferta = '$id_oferta'");
    if ($desactivar) {
        $xdatos ['typeinfo'] = 'Success';
        $xdatos ['msg'] = 'Oferta eliminada correctamente!';
    } else {
        $xdatos ['typeinfo'] = 'Error';
        $xdatos ['msg'] = 'La Oferta no pudo ser eliminada!';
    }	
