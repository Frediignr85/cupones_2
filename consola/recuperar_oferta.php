...
<div class="modal-header">
    ...
    <h4 class="modal-title text-navy">Recuperar Oferta</h4>
</div>
...
function recuperar()
{
    ...
    $recuperar = _update($tabla, $form_data, $where);
    if ($recuperar) {
        $xdatos ['typeinfo'] = 'Success';
        $xdatos ['msg'] = 'Oferta recuperada correctamente!';
    } else {
        $xdatos ['typeinfo'] = 'Error';
        $xdatos ['msg'] = 'La Oferta no pudo ser recuperada!';
    }	
