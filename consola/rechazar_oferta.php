...
<div class="modal-header">
    ...
    <h4 class="modal-title text-navy">Rechazar Oferta</h4>
</div>
            ...
            <?php	if ($links!='NOT' || $admin=='1' ){ ?>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <textarea name="motivo_rechazo" id="motivo_rechazo" style="width:100%" rows="5"></textarea>
                    </div>
                </div>
...
function rechazar()
{
    ...
    $rechazar = _update($tabla, $form_data, $where);
    if ($rechazar) {
        $xdatos ['typeinfo'] = 'Success';
        $xdatos ['msg'] = 'Oferta rechazada correctamente!';
    } else {
        $xdatos ['typeinfo'] = 'Error';
        $xdatos ['msg'] = 'La Oferta no pudo ser rechazada!';
    }	
