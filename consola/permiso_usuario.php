...
function initial()
{
  ...
  list($uri2,$filename)=explode("/",$uri);
      ...
      <div class="col-lg-12">
        ...
        ?>
          <div class="ibox-title">
            <h3><i class="fa fa-lock"></i> <b><?php echo $title;?></b></h3>
          </div>
          <div class="ibox-content">
            ...
            <div class="row">
              ...
              <div class="row"><br><br>
              <?php
              echo"<div class='form-group col-lg-12' id='div_modules_edit'>";
                  ...
                  if($admin=='1')
                  {
                    ...
                    if($numrow2>0)
                    {
                      for($j=0;$j<$numrow2;$j++)
                      {
                        ...
                        echo"<p>";
                        echo"<div class='checkbox i-checks'><label> <input  id='myCheckboxes' name='myCheckboxes' type='checkbox' value='$id_modulo' checked class='i-checks'> <i></i>".ucfirst($modulo)."</label></div>";
                        echo"</p>";
                      }
                    }
                  }
  ...
  <?php
  include("footer.php");
  echo "<script src='js/funciones/funciones_usuario.js'></script>";
  } //permiso del script
  else {
